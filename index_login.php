            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="basket.php" role="button" style="padding-right:0"><span class="btn btn-large btn-success">basket</span></a>
                        </li>
                        <li>
                            <a href="messageFromAdmin.php" role="button" style="padding-right:0"><span class="btn btn-large btn-success">Message</span></a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
                            ...
                            <div class="form-group">
                                <div class="thumbnail">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-sm-3 ">Ilość:</label>
                                        <form action="basket.php?id=<?php echo $allProduct[$i]->getIdProduct();?>" method="POST">
                                            <input type="number" name="quantity" value="1" min="1"
                                                   max="<?php echo $allProduct[$i]->getQuantity();?>" class="form-control" id="inputCount">
                                            <div class="form-group">
                                                <div class="col-sm-12">
